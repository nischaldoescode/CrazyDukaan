  ...
  const renderCartItems = () => {
    return cartData.map((item, index) => {
      ...
      return (
        <div
          key={index}
          className="py-4 border-t border-b border-gray-100 text-gray-700 grid grid-cols-1 sm:grid-cols-[4fr_2fr_0.5fr] lg:grid-cols-[4fr_2fr_0.5fr] items-start sm:items-center gap-4"
        >
