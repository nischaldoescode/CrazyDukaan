...
const Loader = () => {
  ...
  useEffect(() => {
    const timer1 = setTimeout(() => setShowFinalText(true), 3000);
    const timer2 = setTimeout(() => setShowLoader(false), 4500);
        ...
        >
          <div className="flex flex-col items-center justify-center w-full max-w-xs px-4">
            ...
            {!showFinalText ? (
              ...
              // Final text animation - words flying in from different directions
              <motion.div 
